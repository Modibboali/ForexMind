...
def build_checkpoint_state(
    *,
    ...
    validation_episode_count: int | None = None,
    validation_episode_specs: list[dict[str, Any]] | None = None,
    validation_summary: dict[str, Any] | None = None,
    legacy_selection_score: float | None = None,
    ...
    return {
        ...
        "validation_episode_specs": validation_episode_specs or [],
        "validation_summary": validation_summary or {},
        "legacy_selection_score": legacy_selection_score,
